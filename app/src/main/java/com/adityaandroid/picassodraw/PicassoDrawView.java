...
public class PicassoDrawView extends View{
    public static final float TOUCH_TOLERENCE=10;
    ...
    public PicassoDrawView(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        init();
    }
    ...
    void init(){
        ...
        paintLine=new Paint();
        paintLine.setAntiAlias(true); // making drawing smooth
    ...
    private void touchStarted(float x, float y, int pointerId) {
        ...
        Point point; // stores point for given touch
        ...
        // move to the coordonates of the  touch
        path.moveTo(x, y);
        point.x=(int)x;
        point.y=(int)y;
    }
    private void touchMoved(MotionEvent event) {
        for (int i = 0; i < event.getPointerCount(); i++) {
            ...
            if (pathMap.containsKey(pointerId)) {
                ...
                if (deltaX >= TOUCH_TOLERENCE ||
                        deltaY >= TOUCH_TOLERENCE) {
